...
//Find Reference
FLEXFUNC flex_find_reference(BOARD, u8 axisOrVectorSpace, u16 axisOrVSMap, u8 type);

//Wait Reference
FLEXFUNC flex_wait_reference(BOARD, u8 axisOrVectorSpace, u16 axisOrVSMap, u32 timeout, u16 *found);

//Check Reference
FLEXFUNC flex_check_reference(BOARD, u8 axisOrVectorSpace, u16 axisOrVSMap, u16 *found);
...
//Read per Axis Reference Status
FLEXFUNC flex_read_reference_status(BOARD, u8 axis, u8 returnVector);

//Read per Axis Reference Status
FLEXFUNC flex_read_reference_status_rtn(BOARD, u8 axis, u16 FAR *referenceStatus);
