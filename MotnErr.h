...
#define NIMC_packetLengthError               -70013 // Command packet length is incorrect.  Your FlexMotion controller firmware 
                                                    // may be out of date.
...
#define NIMC_noBoardConfigInfoError          -70019 // Controller configuration information is missing or corrupt.  A motion 
...
#define NIMC_reservedOnBoardProgramError     -70040 // Device is reserved for on board program. The current device is reserved 
                                                    // for on board program while download process is in progress.
...
#define NIMC_homeLimitNotEnabledError        -70117 // Find Reference function cannot execute because the Home and/or Limit 
                                                    // inputs are not enabled.  Either enable Limits or use SmartEnable feature.
#define NIMC_findHomeError                   -70118 // Find home was not successful because the motor stopped before the home 
                                                    // switch was found.
...
#define NIMC_moduloBreakpointError           -70123 // The breakpoint value or the breakpoint window loaded exceeds the modulo 
                                                    // range.
...
#define NIMC_findReferenceError              -70165 // Find Reference was not successful because the motor stopped before the 
                                                    // reference was found.
#define NIMC_followingErrorOnFindReference   -70166 // Find Reference sequence did not find reference successfully because the 
