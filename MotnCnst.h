...
/************************************ MISC ********************************************/
#define  MAX_TRIGGER_NUMBER 8
#define  MAX_NUM_AXIS_VALUEMOTION 4
#define  MAX_NUM_AXIS_FLEXMOTION 8
...
#define  NIMC_PROGRAM_DLOAD_STOP			0			// stop download on board program
#define  NIMC_PROGRAM_DLOAD_START		1			// start dload
#define	NIMC_PROGRAM_DLOAD_PROGRESS	2			// dload in progress
...
#define	NIMC_CONDITION_CENTER_FOUND						22 // Center found
#define	NIMC_CONDITION_FORWARD_LIMIT_FOUND				23 // Forward Limit found
#define	NIMC_CONDITION_REVERSE_LIMIT_FOUND				24 // Reverse Limit found
#define  NIMC_CONDITION_RTSI_WAIT                     25 // Wait on RTSI 
...
#define NIMC_BREAKPOINT7      35
#define NIMC_BREAKPOINT8      36
#define NIMC_PHASE_A7         37
#define NIMC_PHASE_A8         38
#define NIMC_PHASE_B7         39
#define NIMC_PHASE_B8         40
#define NIMC_INDEX7           41
#define NIMC_INDEX8           42
...
#define NIMC_MIX_AXVS_CTRL			0x60
...
#define NIMC_DAC7	0x037
#define NIMC_DAC8	0x038
...
//Find Reference
#define NIMC_EXECUTE_FIND_HOME           0x00
#define NIMC_EXECUTE_FIND_INDEX          0x01
#define NIMC_EXECUTE_FIND_CENTER         0x02
#define NIMC_EXECUTE_FIND_FORWARD_LIMIT  0x03
#define NIMC_EXECUTE_FIND_REVERSE_LIMIT  0x04
#define NIMC_EXECUTE_FIND_SEQUENCE       0x05
#define NIMC_MAX_FIND_TYPES	5


// informationType Constants for getu32/setu32 & getf64/setf64 functions.
// Developer Note: see setget.h in firmware before making changes to constant values
#define NIMC_HOME_FINAL_SEARCH_DIR				0x0001		// Attribute specifying the final search direction
#define NIMC_HOME_INITIAL_SEARCH_DIR			0x0002      // Attribute specifying the initial search direction for finding home
#define NIMC_HOME_EDGE_TO_STOP_ON				0x0003      // Attribute specifying the edge to stop on
#define NIMC_HOME_RESET_POSITION					0x0004      // Attribute specifying if we should reset position
#define NIMC_HOME_SMART_ENABLE					0x0005      // Attribute specifying if we should enable smart enabling of limit switches
#define NIMC_HOME_OFFSET							0x0006      // Attribute specifying the offset move after the find
#define NIMC_HOME_PRIMARY_POSITION				0x0007      // Attribute specifying the primary position to reset to
#define NIMC_HOME_SECONDARY_POSITION			0x0008      // Attribute specifying the secondary position to reset to
#define NIMC_HOME_ORDER								0x0009      // Attribute specifying the order for find sequence
#define NIMC_HOME_MAX_VEL							0x000A      // Attribute specifying the max velocity of the find in counts/sec		
#define NIMC_HOME_MAX_RPM							0x000B      // Attribute specifying the max velocity of the find in rpm
#define NIMC_HOME_FINAL_APPROACH_VEL			0x000C      // Attribute specifying the max velocity of the final approach in counts/sec
#define NIMC_HOME_FINAL_APPROACH_RPM			0x000D      // Attribute specifying the max velocity of the final approach in rpm

#define NIMC_INDEX_SEARCH_DIR						0x0012      // Attribute specifying the initial search direction for finding the index
#define NIMC_INDEX_RESET_POSITION				0x0014      // Attribute specifying if we should reset position
#define NIMC_INDEX_SMART_ENABLE					0x0015      // Attribute specifying if we should enable smart enabling of limit switches
#define NIMC_INDEX_OFFSET							0x0016      // Attribute specifying the offset move after the find
#define NIMC_INDEX_PRIMARY_POSITION				0x0017      // Attribute specifying the primary position to reset to
#define NIMC_INDEX_SECONDARY_POSITION			0x0018      // Attribute specifying the secondary position to reset to
#define NIMC_INDEX_ORDER							0x0019      // Attribute specifying the order for find sequence
#define NIMC_INDEX_MAX_VEL							0x001A      // Attribute specifying the max velocity of the find in counts/sec		
#define NIMC_INDEX_MAX_RPM							0x001B      // Attribute specifying the max velocity of the find in rpm
#define NIMC_INDEX_OFFSET_VEL						0x001C      // Attribute specifying the max velocity of the offset move in counts/sec
#define NIMC_INDEX_OFFSET_RPM						0x001D      // Attribute specifying the max velocity of the offset move in rpm

#define NIMC_CENTER_FINAL_SEARCH_DIR			0x0021      // Attribute specifying the final search direction for each of the fwd and rev limits
#define NIMC_CENTER_SEARCH_DIR					0x0022      // Attribute specifying the initial search direction for finding the center
#define NIMC_CENTER_RESET_POSITION				0x0024      // Attribute specifying if we should reset position
#define NIMC_CENTER_SMART_ENABLE					0x0025      // Attribute specifying if we should enable smart enabling of limit switches
#define NIMC_CENTER_OFFSET							0x0026      // Attribute specifying the offset move after the find
#define NIMC_CENTER_PRIMARY_POSITION			0x0027      // Attribute specifying the primary position to reset to
#define NIMC_CENTER_SECONDARY_POSITION			0x0028      // Attribute specifying the secondary position to reset to
#define NIMC_CENTER_ORDER							0x0029      // Attribute specifying the order for find sequence
#define NIMC_CENTER_MAX_VEL						0x002A      // Attribute specifying the max velocity of the find in counts/sec		
#define NIMC_CENTER_MAX_RPM						0x002B      // Attribute specifying the max velocity of the find in rpm
#define NIMC_CENTER_FINAL_APPROACH_VEL			0x002C      // Attribute specifying the max velocity of the final approach in counts/sec
#define NIMC_CENTER_FINAL_APPROACH_RPM			0x002D      // Attribute specifying the max velocity of the final approach in rpm

#define NIMC_FORWARD_LIMIT_FINAL_SEARCH_DIR	0x0031      // Attribute specifying the final search direction
#define NIMC_FORWARD_LIMIT_RESET_POSITION		0x0034      // Attribute specifying if we should reset position
#define NIMC_FORWARD_LIMIT_SMART_ENABLE		0x0035      // Attribute specifying if we should enable smart enabling of limit switches
#define NIMC_FORWARD_LIMIT_OFFSET				0x0036      // Attribute specifying the offset move after the find
#define NIMC_FORWARD_LIMIT_PRIMARY_POSITION	0x0037      // Attribute specifying the primary position to reset to
#define NIMC_FORWARD_LIMIT_SECONDARY_POSITION	0x0038   // Attribute specifying the secondary position to reset to
#define NIMC_FORWARD_ORDER							0x0039      // Attribute specifying the order for find sequence
#define NIMC_FORWARD_LIMIT_MAX_VEL				0x003A      // Attribute specifying the max velocity of the find in counts/sec		
#define NIMC_FORWARD_LIMIT_MAX_RPM				0x003B      // Attribute specifying the max velocity of the find in rpm
#define NIMC_FORWARD_LIMIT_FINAL_APPROACH_VEL	0x003C   // Attribute specifying the max velocity of the final approach in counts/sec
#define NIMC_FORWARD_LIMIT_FINAL_APPROACH_RPM	0x003D   // Attribute specifying the max velocity of the final approach in rpm

#define NIMC_REVERSE_LIMIT_FINAL_SEARCH_DIR	0x0041      // Attribute specifying the final search direction
#define NIMC_REVERSE_LIMIT_RESET_POSITION		0x0044      // Attribute specifying if we should reset position
#define NIMC_REVERSE_LIMIT_SMART_ENABLE		0x0045      // Attribute specifying if we should enable smart enabling of limit switches
#define NIMC_REVERSE_LIMIT_OFFSET				0x0046      // Attribute specifying the offset move after the find
#define NIMC_REVERSE_LIMIT_PRIMARY_POSITION	0x0047      // Attribute specifying the primary position to reset to
#define NIMC_REVERSE_LIMIT_SECONDARY_POSITION	0x0048   // Attribute specifying the secondary position to reset to
#define NIMC_REVERSE_ORDER							0x0049      // Attribute specifying the order for find sequence
#define NIMC_REVERSE_LIMIT_MAX_VEL				0x004A      // Attribute specifying the max velocity of the find in counts/sec		
#define NIMC_REVERSE_LIMIT_MAX_RPM				0x004B      // Attribute specifying the max velocity of the find in rpm
#define NIMC_REVERSE_LIMIT_FINAL_APPROACH_VEL	0x004C   // Attribute specifying the max velocity of the final approach in counts/sec
#define NIMC_REVERSE_LIMIT_FINAL_APPROACH_RPM	0x004D   // Attribute specifying the max velocity of the final approach in rpm

#define NIMC_REFERENCE_POLLING_INTERVAL		0x0052      // Attribute specifying the polling interval for waiting
#define NIMC_REFERENCE_FOUND						0x0053      // The type of find last executed only for READ     
#define NIMC_REFERENCE_FINDING					0x0054      // To Retrieve the finding variable only for READ
#define NIMC_REFERENCE_CURRENT_PHASE			0x0055		// The current phase if running a find sequence
#define NIMC_BUS_TIMEOUT							0x0100      // Attribute specifying the time out value for remote device
#define NIMC_RT_CLOCK								0x0101		// Attribute specifying the real time clock on the ENET-Motion box.
#define NIMC_BP_WINDOW								0x0200		// Attribute specifying the window for enabling breakpoint
#define NIMC_PROGRAM_AUTOSTART					0x0300		// Attribute specifying the program that is enabled for auto start
...
//Board Local or Remote
#define NIMC_LOCAL_BOARD   1
#define NIMC_REMOTE_BOARD  2
